...
analyses that run in the Shiny App, but with more flexibility by adding
your own colonies or editing species attributes.

## Installation

You can install the development version of BirdynamicPkg from
