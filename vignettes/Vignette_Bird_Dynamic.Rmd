...
```{r parc_example2}
windfarms_bis <- st_as_sf(data.frame(lon=c(3.214, 3.606, 5.026), lat=c(43.118, 43.283, 43.292), NAME=c("W1", "W2", "P3")), coords = c("lon","lat"), crs=st_crs(4326)) %>% st_transform(., st_crs(2154))
```
